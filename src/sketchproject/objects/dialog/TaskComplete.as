package sketchproject.objects.dialog
{
	...
	public class TaskComplete extends Sprite implements IDialog
	{
		...
		public function TaskComplete(textInfo:String)
		{
			super();
			...
			dialogIcon = new Image(Assets.getAtlas(Assets.TEXTURE_ACHIEVEMENT, Assets.TEXTURE_ACHIEVEMENT_XML).getTexture("icon_task_complete"));
